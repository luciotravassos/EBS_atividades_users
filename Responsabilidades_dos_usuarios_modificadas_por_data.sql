SELECT b.user_id "USERID",
       ...
       b.description "DESCRI플O",
       f.full_name "NOME",
       a.start_date "DATA DE CRIA플O",
       a.end_date "DATA DE EXPIRA플O",
       c.responsibility_name,
       g.start_date "DATA DE CONCESS홒",
       g.end_date "DATA DE REVOGA플O",
 ...
 WHERE a.user_id = b.user_id
  ...
  -- AND a.start_date  > '01/JAN/2006'
 ORDER BY b.user_id, a.start_date,c.responsibility_name